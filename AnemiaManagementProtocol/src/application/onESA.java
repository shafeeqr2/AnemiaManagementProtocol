...
public class onESA extends JPanel {
	...
	private JRadioButton rdbtnTest_1 = new JRadioButton("Yes, they are currently recieving ESA");

	private JRadioButton rdbtnTest = new JRadioButton("No, it is currently on hold");
	
	private JRadioButton rdbtnNewRadioButton = new JRadioButton("No, it has been discontinued");
	...
	public JRadioButton radio_no_onHold() {
		return rdbtnTest;
	}
	
	public JRadioButton radio_no_discontinued() {
