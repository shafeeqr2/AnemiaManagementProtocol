...
public class EsaDosageAranesp extends JPanel {
...
private ButtonGroup group;
	...
	private JRadioButton rdbtnTest_1 = new JRadioButton("10 mcg every 2 weeks");

	private JRadioButton rdbtnTest_2 = new JRadioButton("10 mcg every 1 week");

	private JRadioButton rdbtnTest_3 = new JRadioButton("20 mcg every 1 week");

	private JRadioButton rdbtnTest_4 = new JRadioButton("30 mcg every 1 week");
	
	private JRadioButton rdbtnTest_5 = new JRadioButton("40 mcg every 1 week");
	
	private JRadioButton rdbtnTest_6 = new JRadioButton("50 mcg every 1 week");
	
	private JRadioButton rdbtnTest_7 = new JRadioButton("60 mcg every 1 week");
	
	private JRadioButton rdbtnTest_8 = new JRadioButton("80 mcg every 1 week");
	
	private JRadioButton rdbtnTest_9 = new JRadioButton("100 mcg every 1 week");

	private JRadioButton rdbtnTest_10 = new JRadioButton("130 mcg every 1 week");
	
	private JRadioButton rdbtnTest_11 = new JRadioButton("150 mcg every 1 week");
	...
	public String get_option() {
		...
		else return rdbtnTest_11.getText();
		

	}
	
	public EsaDosageAranesp() {
		//this.window = window;
		setBorder(null);
		setLayout(null);
		
		JLabel lblIsThePatient = new JLabel("Please select the Aranesp Dosage: ");
